...
namespace SOSFashion
{
    public partial class ShopForm : Form
    {
        ...
        public ShopForm()
        {
            ...
            HidePanels();
            using (StreamReader reader = new(itemsFilePath))
            {
        ...
        public void GetItem(string ItemName)
        {
            foreach (Item item in itemsList)
            {
                ...
                {
                    // If a matching item is found, set the text and break out of the loop
